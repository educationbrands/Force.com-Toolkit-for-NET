...
namespace Salesforce.Force
{
    public interface IForceClient : IDisposable
    {
        ...
        Task<List<BatchResultList>> RunJobAndPollAsync<T>(string objectName, BulkConstants.OperationType operationType, IEnumerable<ISObjectList<T>> recordsLists, Action<JobInfoResult> onPoll = null, bool throwOnBatchTimeout = true);
